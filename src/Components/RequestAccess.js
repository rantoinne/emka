        ...
        return (
            <View style={{ flex: 1, justifyContent: 'flex-start', alignItems: 'center' }}>
                <LinearGradient colors={['#43B0E8', '#666CDD']} start={{ x: 0.05, y: 0 }} end={{ x: 0, y: 1 }}
                    ...
                    <Text style={{ fontSize: 18, fontFamily: 'Montserrat-SemiBold', color: 'white' }}>Request Access</Text>
                </LinearGradient>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', width: '90%', padding: 0, marginTop: 50 }}>
                    ...
                    <TouchableOpacity>
                        <LinearGradient colors={['#666CDD', '#666CDD']} style={{ width: (width / 2) - 50, marginTop: 20, flexDirection: 'row', padding: 8, paddingVertical: 10, borderRadius: 4, justifyContent: 'center', alignItems: 'center' }}>
                            <Text style={{ fontSize: 15, fontFamily: 'Montserrat-SemiBold', color: 'white', }}>Request</Text>
                        </LinearGradient>
                    </TouchableOpacity>
